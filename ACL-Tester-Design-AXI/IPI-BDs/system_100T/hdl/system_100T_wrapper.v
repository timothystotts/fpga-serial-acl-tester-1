...
module system_100T_wrapper
  ...
  input reset;
  output [6:0]seg_gpio_ja_tri_o;
  output ssd_mux_ja_tri_o;
  input sys_clock;
  input usb_uart_rxd;
  output usb_uart_txd;
  ...
  wire reset;
  wire [6:0]seg_gpio_ja_tri_o;
  wire ssd_mux_ja_tri_o;
  wire sys_clock;
  wire usb_uart_rxd;
  wire usb_uart_txd;
  ...
  system_100T system_100T_i
       (.ddr3_sdram_addr(ddr3_sdram_addr),
        ...
        .reset(reset),
        .seg_gpio_ja_tri_o(seg_gpio_ja_tri_o),
