...
################################################################
# This is a generated script based on design: system_100T
#
...
digilentinc.com:IP:PmodACL2:1.0\
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M04_AXI [get_bd_intf_pins PWM_0/PWM_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M04_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M05_AXI [get_bd_intf_pins PWM_1/PWM_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M05_AXI]
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M08_AXI [get_bd_intf_pins MuxSSD_0/S00_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M08_AXI]
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M10_AXI [get_bd_intf_pins PmodACL2_0/AXI_LITE_GPIO] [get_bd_intf_pins microblaze_0_axi_periph/M10_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M11_AXI [get_bd_intf_pins PmodACL2_0/AXI_LITE_SPI] [get_bd_intf_pins microblaze_0_axi_periph/M11_AXI]
  ...
  connect_bd_net -net PmodACL2_0_GPIO_Interrupt [get_bd_pins PmodACL2_0/GPIO_Interrupt] [get_bd_pins microblaze_0_xlconcat/In3]
  ...
  connect_bd_net -net clk_wiz_0_clk_out3 [get_bd_ports eth_ref_clk] [get_bd_pins clk_wiz_0/clk_out3] [get_bd_pins proc_sys_reset_0/slowest_sync_clk]
  connect_bd_net -net clk_wiz_0_clk_out4 [get_bd_pins MuxSSD_0/ext_mux_clk] [get_bd_pins PmodACL2_0/ext_spi_clk] [get_bd_pins PmodCLS_0/ext_spi_clk] [get_bd_pins axi_quad_spi_0/ext_spi_clk] [get_bd_pins clk_wiz_0/clk_out4]
  ...
  connect_bd_net -net reset_1 [get_bd_ports reset] [get_bd_pins clk_wiz_0/resetn] [get_bd_pins mig_7series_0/sys_rst] [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins rst_mig_7series_0_83M/ext_reset_in]
  ...
  assign_bd_address -offset 0x44A50000 -range 0x00008000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs PmodACL2_0/AXI_LITE_SPI/Reg0] -force
